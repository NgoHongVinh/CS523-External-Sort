...
Đây là project xây dựng **trình mô phỏng (visualizer) thuật toán External Merge Sort** – một thuật toán sắp xếp ngoài (external sorting) được sử dụng khi dữ liệu quá lớn và không thể chứa toàn bộ trong bộ nhớ chính (RAM).
